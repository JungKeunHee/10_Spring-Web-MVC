...
public class MenuService {
    ...
    @Autowired
    public MenuService(MenuMapper menuMapper, UrlPathHelper mvcUrlPathHelper){
    ...
    *   묶는 것을 의미한다. 따라서 데이터베이스에 조작에 관련 된 일이
    ...
    *  */
    ...
    public void updateMenu(MenuDTO updateMenu) {
        ...
        menuMapper.updateMenu(updateMenu);
    ...
    @Transactional
    public void deleteMenuCode(MenuDTO code) {

        menuMapper.deleteMenuCode(code);
    }
}
