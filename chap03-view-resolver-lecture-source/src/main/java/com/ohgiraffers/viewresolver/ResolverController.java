...
public class ResolverController {
    ...
    *  */
    ...
    public String stringReturn(Model model) {
        ...
        model.addAttribute("fowardMessage", "문자열로 view 반환");
    ...
    public String redirectAttr(RedirectAttributes attr){
        ...
        *  */
        attr.addFlashAttribute("flashMessage", "리다이렉트 시 값 유지!!");
    ...
    *  */
    ...
    public ModelAndView modelAndViewReturn(ModelAndView mv){
        ...
        mv.addObject("fowardMessage", "ModelAndView 를 이용해서 반환");

        // 문자열로 이용하고 싶은 view 페이지를 지정할 수 있다.
    ...
    public ModelAndView mvRedirectAttr(ModelAndView mv, RedirectAttributes attr){
        ...
        attr.addFlashAttribute("flashMessage", "ModelAndView 리다이렉트 시 값 유지!!!");
